...
Usage:
    ...
    python -m rsis dashboard     # Start the web dashboard
...
def cmd_dashboard(args: argparse.Namespace) -> int:
    ...
    print(f"RSIS v{__version__} — Starting dashboard at http://{host}:{port}")
...
def main() -> int:
    ...
    p_dash.add_argument("--port", "-p", type=int, default=8080, help="Port")
